...
chk('base: 07:00 ge50 2 flights → 13:00', d.out === '13:00');
...
chk('conv: base still 13:00 (10:00 Eastern row)', c.out === '13:00');
...
chk('split night 180 min → 15:15', s.out === '15:15');
...
chk('split day 60 min → 13:08', sd.out === '13:08');
...
chk('split 59 min (< 60) → no extension, stays 13:00', short.out === '13:00');
...
chk('cap: capped at 18:00', cap.out === '18:00');
...
chk('late 23:30 · 6 flights → 9:00', late.out === '9:00');
