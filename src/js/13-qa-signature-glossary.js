...
const FAQS = [
 ...
 a: 'Two separate rules. CAR 401.05(3): within the preceding 24 months you must have passed an instrument rating flight test, an instrument proficiency check, or a competency or proficiency check that includes instrument procedures. For aeroplanes operated under Subpart 5 of Part VII (airline operations), a PPC under Standard 725.106 counts — CAR 401.05(3)(d)(iv)(G). CAR 401.05(3.1): from the first day of the seventh month after that test or check, and within the six months before the flight, you must have completed 6 instrument approaches — in an aircraft in actual or simulated IMC, in a Level B, C or D full-flight simulator of the same group, or in a flight training device under qualified supervision. The current regulation sets no instrument-time requirement. The 6 months is a rolling window, counted backward from the day you want to fly IFR.',
 qFr: 'Qu\'est-ce que la validité IFR et combien de temps est-elle bonne ?',
 aFr: 'Deux règles distinctes. RAC 401.05(3) : dans les 24 mois précédents, vous devez avoir réussi un test en vol de qualification aux instruments, un contrôle de compétence aux instruments, ou un contrôle de compétence comprenant une partie sur les procédures aux instruments. Pour les avions exploités en vertu de la sous-partie 5 de la partie VII (exploitation d\'une entreprise de transport aérien), un PPC selon la norme 725.106 compte — RAC 401.05(3)d)(iv)(G). RAC 401.05(3.1) : à partir du 1er jour du 7e mois suivant ce test ou contrôle, et dans les six mois précédant le vol, vous devez avoir effectué 6 approches aux instruments — en aéronef en IMC réelle ou simulée, dans un simulateur de vol complet de niveau B, C ou D du même groupe, ou dans un dispositif d\'entraînement au vol sous supervision qualifiée. Le règlement actuel n\'impose aucune exigence d\'heures aux instruments. La fenêtre de 6 mois est glissante, comptée à rebours à partir du jour où vous voulez voler en IFR.'
 },
 {
